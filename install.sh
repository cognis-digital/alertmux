#!/usr/bin/env sh
# Universal installer for alertmux. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/alertmux.git"
echo "Installing alertmux ..."
