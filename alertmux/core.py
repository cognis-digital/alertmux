"""ALERTMUX core — Alert dedup, correlation, and routing in front of Grafana / PagerDuty."""
...
RULES = [
    ("ALE-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ALE-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ALE-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
