"""Native cognis-connect emit for alertmux — forward findings to any platform.

Maps alertmux's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    alertmux ... --format json | alertmux-emit --to stix
    alertmux-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
