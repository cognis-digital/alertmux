...
import argparse, sys
from alertmux.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="alertmux", description="ALERTMUX — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from alertmux.mcp_server import serve
        return serve()
    if args.cmd == "scan":
